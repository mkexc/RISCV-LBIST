...
vcom -work work_gate -mixedsvvh -novopt ${root_dir}/bist/constants.vhd \
	${root_dir}/bist/COMPONENTS/clk_divisor.vhd \
	${root_dir}/bist/COMPONENTS/mux.vhd \
	${root_dir}/bist/CONTROLLER/ROM.vhd \
	${root_dir}/bist/CONTROLLER/controller.vhd \
	${root_dir}/bist/LFSR/lfsr.vhd \
	${root_dir}/bist/LFSR/PHASE_SHFT.vhd \
	${root_dir}/bist/MISR/misr.vhd \
	${root_dir}/bist/MISR/SPACE_COMP.vhd 

vlog -sv -work work_gate -cover t -novopt -timescale "1 ns/ 1 ps"  -suppress 2577 -suppress 2583  \
	${root_dir}/gate/riscv_core_scan64.v \
	...
	${root_dir}/tb/core/cluster_clock_gating_nangate.sv \
